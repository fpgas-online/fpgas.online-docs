...
pins are `2:3:4:14`, P1 lands on the I2C and UART GPIOs, and the PCIe bus is
`0000:01:00.0` on pi14 but `0001:01:00.0` on pi16 and pi20; see
[PS1](../../sites/ps1.md#wiring).
